...

{
  age.secrets = {
    ...
    "ssh-id_ed25519_gh_work" = {
      file = ../../../secrets/ssh/id_ed25519_gh_work.age;
      path = "${config.home.homeDirectory}/.ssh/id_ed25519_gh_work";
      mode = "600";
    };

    "ssh-id_ed25519_sk" = {
      file = ../../../secrets/ssh/id_ed25519_sk.age;
      path = "${config.home.homeDirectory}/.ssh/id_ed25519_sk";
      mode = "600";
    };

    "ssh-id_ed25519_sk_gh_auth_pers" = {
      file = ../../../secrets/ssh/id_ed25519_sk_gh_auth_pers.age;
      path = "${config.home.homeDirectory}/.ssh/id_ed25519_sk_gh_auth_pers";
      mode = "600";
    };

    "ssh-id_ed25519_gh_sign_pers" = {
      file = ../../../secrets/ssh/id_ed25519_gh_sign_pers.age;
      path = "${config.home.homeDirectory}/.ssh/id_ed25519_gh_sign_pers";
      mode = "600";
    };
  };
