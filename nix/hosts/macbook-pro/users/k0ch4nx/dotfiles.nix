...

{
  xdg.configFile = {
    ...
    "topgrade/topgrade.toml".source =
      config.lib.file.mkOutOfStoreSymlink "${config.home.homeDirectory}/Developer/github.com/k0ch4nx/dotfiles/nix/hosts/macbook-pro/users/k0ch4nx/files/topgrade/topgrade.toml";
    "wezterm".source = ./files/wezterm;
    "yabai".source = ./files/yabai;
    "ferium/config.json" = {
      source = config.lib.file.mkOutOfStoreSymlink "/Users/k0ch4nx/Developer/github.com/k0ch4nx/dotfiles/nix/hosts/macbook-pro/users/k0ch4nx/files/ferium/config.json";
      force = true;
    };
  };
  ...
  home.file = {
    ".config/opencode/opencode.json" = {
      source = config.lib.file.mkOutOfStoreSymlink "/Users/k0ch4nx/Developer/github.com/k0ch4nx/dotfiles/nix/hosts/macbook-pro/users/k0ch4nx/files/opencode/opencode.json";
      force = true;
    };
    ".config/opencode/oh-my-openagent.json" = {
      source = config.lib.file.mkOutOfStoreSymlink "/Users/k0ch4nx/Developer/github.com/k0ch4nx/dotfiles/nix/hosts/macbook-pro/users/k0ch4nx/files/opencode/oh-my-openagent.json";
      force = true;
    };
